defmodule AskFlowWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AskFlowWeb.Gettext
  ...
  def markdown(assigns) do
    ...
    markdown_html =
      ...
      |> String.replace("<pre>", "<pre style='overflow-x: auto; white-space: pre-wrap;'>")
      |> Phoenix.HTML.raw()
  ...
  attr :placeholder, :string, default: "No entries found"

  slot :inner_block, required: true

  def sidebar_cards(assigns) do
    ~H"""
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AskFlowWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AskFlowWeb.Gettext, "errors", msg, opts)
    end
  end
